...
# Create the model
model = SimpleVine3D(20, d=.50, m_b = 1., J_b =[0.08458333333333333, 0.08458333333333333,0.0012500000000000002], stiffness = 0*50000., damping=0*30000.)
n,m = size(model)

# Generate initial state
rotations = [RotX(pi/4) for i=1:model.nb]
...
plot(Z[2:7:model.nq,:]',legend=false)
